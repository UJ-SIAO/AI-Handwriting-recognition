...
#define AI_TOOLS_DATE_TIME   "Wed Dec 23 21:25:31 2020"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 64, 64, 1, 1), AI_STRIDE_INIT(4, 1, 64, 4096, 4096),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 784, 64, 1, 1), AI_STRIDE_INIT(4, 1, 784, 50176, 50176),
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_3_bias_array.data = AI_PTR(weights + 59392);
    dense_3_bias_array.data_start = AI_PTR(weights + 59392);
    dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_weights_array.data = AI_PTR(weights + 56832);
    dense_3_weights_array.data_start = AI_PTR(weights + 56832);
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(weights + 56576);
    dense_2_bias_array.data_start = AI_PTR(weights + 56576);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(weights + 52480);
    dense_2_weights_array.data_start = AI_PTR(weights + 51456);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights + 51200);
    dense_1_bias_array.data_start = AI_PTR(weights + 51200);
